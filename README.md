...
* [InfluxDB Suricata Input Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/suricata) ⭐ 17,831 | 🐛 419 | 🌐 Go | 📅 2026-09-25 - Input Plugin for Telegraf to collect and forward Suricata `stats` logs (included out of the box in recent Telegraf releases).
...
* [Antiphishing](https://github.com/julioliraup/Antiphishing) ⭐ 38 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - Suricata rules and datasets to detect phishing attacks.
