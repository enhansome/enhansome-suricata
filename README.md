...
* [InfluxDB Suricata Input Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/suricata) ⭐ 17,800 | 🐛 418 | 🌐 Go | 📅 2026-09-11 - Input Plugin for Telegraf to collect and forward Suricata `stats` logs (included out of the box in recent Telegraf releases).
...
* [Malcolm](https://github.com/cisagov/Malcolm) ⭐ 2,508 | 🐛 173 | 🌐 Python | 📅 2026-08-25 - A powerful, easily deployable network traffic analysis tool suite for full packet capture artifacts (PCAP files), Zeek logs and Suricata alerts.
...
* [Antiphishing](https://github.com/julioliraup/Antiphishing) ⭐ 38 | 🐛 2 | 🌐 Python | 📅 2026-09-12 - Suricata rules and datasets to detect phishing attacks.
