...
* [InfluxDB Suricata Input Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/suricata) ⭐ 17,776 | 🐛 427 | 🌐 Go | 📅 2026-08-26 - Input Plugin for Telegraf to collect and forward Suricata `stats` logs (included out of the box in recent Telegraf releases).
...
* [Evebox](https://github.com/jasonish/evebox) ⭐ 496 | 🐛 5 | 🌐 Rust | 📅 2026-08-29 - Web Based Event Viewer (GUI) for Suricata EVE Events in Elastic Search.
...
* [Antiphishing](https://github.com/julioliraup/Antiphishing) ⭐ 36 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Suricata rules and datasets to detect phishing attacks.
