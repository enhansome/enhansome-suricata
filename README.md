...
* [InfluxDB Suricata Input Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/suricata) ⭐ 17,777 | 🐛 427 | 🌐 Go | 📅 2026-08-26 - Input Plugin for Telegraf to collect and forward Suricata `stats` logs (included out of the box in recent Telegraf releases).
...
* [TriageWall](https://github.com/aaronphifer/triagewall) ⭐ 11 | 🐛 6 | 🌐 Python | 📅 2026-08-19 - Local-first analyst workbench for triaging and investigating Suricata and Wazuh alerts with a tunable prefilter and Ollama classifier.
...
* [Malcolm](https://github.com/cisagov/Malcolm) ⭐ 2,500 | 🐛 160 | 🌐 Python | 📅 2026-08-25 - A powerful, easily deployable network traffic analysis tool suite for full packet capture artifacts (PCAP files), Zeek logs and Suricata alerts.
* [Evebox](https://github.com/jasonish/evebox) ⭐ 496 | 🐛 9 | 🌐 Rust | 📅 2026-08-26 - Web Based Event Viewer (GUI) for Suricata EVE Events in Elastic Search.
...
* [Antiphishing](https://github.com/julioliraup/Antiphishing) ⭐ 36 | 🐛 2 | 🌐 Python | 📅 2026-08-28 - Suricata rules and datasets to detect phishing attacks.
