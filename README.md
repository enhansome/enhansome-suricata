...
* [InfluxDB Suricata Input Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/suricata) ⭐ 17,805 | 🐛 415 | 🌐 Go | 📅 2026-09-17 - Input Plugin for Telegraf to collect and forward Suricata `stats` logs (included out of the box in recent Telegraf releases).
...
* [TriageWall](https://github.com/aaronphifer/triagewall) ⭐ 11 | 🐛 7 | 🌐 Python | 📅 2026-09-13 - Local-first analyst workbench for triaging and investigating Suricata and Wazuh alerts with a tunable prefilter and Ollama classifier.
...
* [Malcolm](https://github.com/cisagov/Malcolm) ⭐ 2,511 | 🐛 157 | 🌐 Python | 📅 2026-09-15 - A powerful, easily deployable network traffic analysis tool suite for full packet capture artifacts (PCAP files), Zeek logs and Suricata alerts.
...
* [Antiphishing](https://github.com/julioliraup/Antiphishing) ⭐ 39 | 🐛 2 | 🌐 Python | 📅 2026-09-17 - Suricata rules and datasets to detect phishing attacks.
...
* [Aristotle](https://github.com/secureworks/aristotle) ⭐ 39 | 🐛 1 | 🌐 Python | 📅 2026-07-21 - Simple Python program that allows for the filtering and modifying of Suricata and Snort rulesets based on interpreted key-value pairs present in the metadata keyword within each rule.
